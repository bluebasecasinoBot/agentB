...
__SYD.container = () =>{
    return __c(
        "div",
        {
            style:__sC['container']() + "background-size:contain;background-position:center;background-repeat: no-repeat;"
        },
        [
            __SYD.subContainer(),
            __SYD.MainCanvas(),
...
__SYD.loaderScreen = () =>{
    return __c(
        "div",
        {
            style:`position:fixed;height:100%;width:100%;top:0;left:0;background:#fff;z-index:1000;display:${__p(['loaderScreen' , 'show'], true) ? "flex" : "none"};justify-content:center;align-items:center;z-index:10000;flex-direction:column;row-gap:10px;`,
        },
        [
            __c(
                "img",
            ...
            __c(
                ...
                [
                    __c("span" , {style:"color:#3399FF;text-shadow:2px 2px 1px #141414 , 0 0 1px #000 , 0 0 6px #3399FF;"},["AGENTB "])
                ]
            ),
        ],
        {
...
__SYD.subContainer = () =>{
    ...
    return __c(
        "div",
        {
            style:`min-height:200%;width:100%;height:fit-content;position:relative;display:flex;padding-top:0px;flex-direction:column;row-gap:3rem;align-items:center;color:ffc2cb;z-index:200;`,
            class:"subContainer"
        },
        [
            __SYD.scaleNav(),
