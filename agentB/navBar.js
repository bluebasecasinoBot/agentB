...
__SYD.scaleNav = () =>{
    ...
    return __c(
        "div",
        {
            style:`position:fixed;top:0px;bottom:auto;left:0;width:100%;padding:${check ? "5px 30px" : "5px 10px"};display:flex;align-items:center;column-gap:50px;justify-content:space-between;user-select:none;z-index:1000;background:${"#0D1117"};color:${"#ffc2cb"};font-weight:900;transition:unset;box-shadow:0px 2px 3px #000;transform:translateY(-1px);transition:all linear .3s;`//background:linear-gradient(#000,#0000);
        },
        [   
            __SYD.siteMainTitle(),
    ...
    return __c(
        ...
        [
            __c(
                "div",
                {
                    style:"height:70px;width:100px;background-image:url(../assets/logo.png);cursor:pointer;background-image:url('./assets/AgentBLogo.png');"
                },[],
                {
                    genericStyle:["bg_fit"]
                }
            ),
            __SYD.pTag({text:"AGENTB" , style:"font-size:17px;font-weight:900;color:#fff;"}),
        ],
        {
            genericStyle:['bg_fit'],
            events:{
...
__SYD.dropDownNavMenu_el = () =>{
    return __c(
        "div",
        {
            style:"height:100%;width:100%;background:#0D1117;display:flex;flex-direction:column;row-gap:20px;padding:20px;color:#fff;text-transform:capitalize;animation-duration:.4s;",
    ...
    return __c(
        ...
        [
            ...
            __SYD.ul_lists_el({child:__SYD.pTag({text:"Features" , function_:{onclick:(() =>{
                ...
                location.href = "#feature"
            })} , style:"font-size:17px;font-weight:700;" , class_:"navText"})}),
